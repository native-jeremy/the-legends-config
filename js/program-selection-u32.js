                ...
                <div class="app-block fixed overlay full-height">
                  <div class="app-block-content">
                    <div class="info-block auto-margin">
                      ...
                      <a
                        href="#"
                        data-w-id="5c806ac3-c34a-bc93-6409-9da4edc693c2"
                        class="button-style-1 half w-button"
                        >Program Details</a
                      ><a href="/questionnaire" class="button-style-4 w-button"
                  ...
                  <div class="content">
                    <div class="content-headings margin-bottom">
                      <div class="split-dynamic-text">
                        <div
                          id="Weeks"
                          class="generic-text-style-6 margin-right-split-dnyamic-text weeks_el"
                        >
                          8
                        </div>
                    ...
                    <div class="content-block base-block">
                      ...
                      <div class="content-block-body">
                        <p class="body-copy-text-style-1 description_el">
                          This is the description for this program.<br />This will
                          detail the types of workouts with the program. It should
                          detail to main object of the program and the results that
                          can be expected. This description can be as long as required
                        </p>
                      </div>
                    </div>
                    <div class="content-block">
                      ...
                      <div class="content-block-body">
                        <div class="content-block-body-copy">
                          <p class="body-copy-text-style-1">
                            • &nbsp; &nbsp;Equipment required<br />• &nbsp; &nbsp;Low
                            impact exercises<br />• &nbsp; &nbsp;Functional movements
                            exercises<br />• &nbsp; &nbsp;Build core and back strength
                          </p>
                        </div>
                      </div>
                    </div>
                    <div class="content-block">
                      <div class="content-block-header">
                        <h2 class="main-heading-style-2">
                          Workout Structure (Weekly)
                        </h2>
                      </div>
                      <div class="content-block-body">
                        ...
                        <div class="content-block-body-copy">
                          <p class="body-copy-text-style-1">
                            • &nbsp; &nbsp;Strength &amp; Cardio Circuits (x2) <br />•
                            &nbsp; &nbsp;HIIT Session (low impact) (x1)
                          </p>
                        </div>
                      </div>
                      <div class="content-block-body margin-top">
                        ...
                        <div class="content-block-body-copy">
                          <p class="body-copy-text-style-1">
                            • &nbsp; &nbsp;Full body strength (x1)<br />• &nbsp;
                            &nbsp;30-45min LISS (x2)<br />• &nbsp; &nbsp;Stretch (x1)
                          </p>
                        </div>
                      </div>
                    </div>
                    <div class="content-block">
                      ...
                      <div class="accordion style-2">
                        <div
                          data-w-id="318dd5d4-e2e9-7095-276c-a871128f0316"
                          class="accordion-header style-2"
                        >
                          <h2 class="generic-text-style-6 non-caps">
                        ...
                        <div class="accordion-body style-2">
                          <p class="body-copy-text-style-1">
                            ...
                            detail the types of workouts with the program. It should
                            detail to main object of the program and the results that
                            can be expected. This description can be as long as
                            required
                          </p>
                        </div>
                      </div>
                      <div class="accordion style-2">
                        <div
                          data-w-id="318dd5d4-e2e9-7095-276c-a871128f0321"
                          class="accordion-header style-2"
                        >
                          <h2 class="generic-text-style-6 non-caps">
                      ...
                      <div class="accordion style-2">
                        <div
                          data-w-id="318dd5d4-e2e9-7095-276c-a871128f032c"
                          class="accordion-header style-2"
                        >
                          <h2 class="generic-text-style-6 non-caps">
                            Can I swap Programs?
                      ...
                      <div class="accordion style-2">
                        <div
                          data-w-id="318dd5d4-e2e9-7095-276c-a871128f0337"
                          class="accordion-header style-2"
                        >
                          <h2 class="generic-text-style-6 non-caps">
                    ...
                    <a
                      w-el="questionnaire_user_program_added"
                      data-w-id="318dd5d4-e2e9-7095-276c-a871128f0341"
                      href="/stripe"
                      class="button-style-1 w-button"
                      w-el-onclick-0-0="9165cc42-4c13-4be1-b1f2-51a5a8b8a571-0-0"
                      w-el-onclick-1-0="9165cc42-4c13-4be1-b1f2-51a5a8b8a571-1-0"
                      >Let’s get started</a
                    ><a href="/questionnaire" class="button-style-5 w-button"
                      >back to programs</a
                    ><link rel="prerender" href="/questionnaire" />
                  </div>
                </div>
